...
{
    class Naval_hija_fragata : Naval_Padre_Clase
    {
        private int[] ArrayBarcos = new int[10];
        private int[] ArrayBarcosAuxiliar = new int[10];
        public void DeterminarParametros()
        {
            CantidadBarcos1 = 10;
            PorcentajeBarcosPerdidos1 = 85;
            PorcentajeBarcosIncapacitados1 = 50;
            CantMarinos1 = 250;
            Guardar_Datos();
