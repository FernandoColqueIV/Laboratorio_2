...
{
    class Naval_hija_portaAviones : Naval_Padre_Clase
    {
        private int[] ArrayBarcos = new int[5];
        private int[] ArrayBarcosAuxiliar = new int[5];
        public void DeterminarParametros()
        {
            CantidadBarcos1 = 5;
            PorcentajeBarcosPerdidos1 = 90;
            PorcentajeBarcosIncapacitados1 = 80;
            CantMarinos1 = 2000;
            Guardar_Datos();
